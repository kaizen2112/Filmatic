...
public class OnholdList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onhold_list);
    ...
    private void initView() {
        recyclerView = findViewById(R.id.recyclerViewOnHoldList);
    ...
    private void loadSpecificMovies() {
        ...
        if (currentUser != null) {
            ...
            moviesRef = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("movies").child("onHold");
