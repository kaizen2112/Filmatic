...
public class CompletedList extends AppCompatActivity {
    ...
    private void initView() {
        recyclerView = findViewById(R.id.recyclerViewCompletedList);
    ...
    private void loadSpecificMovies() {
        ...
        if (currentUser != null) {
            ...
            moviesRef = FirebaseDatabase.getInstance().getReference().child("Users").child(uid).child("movies").child("completed");
